...
export default function ResendActivationPage() {
  ...
  const { C, inputSx, error, loading, submitted, submitResendForm } =
    useResendActivation();
        ...
        {!submitted ? (
          ...
          <Fade in timeout={400}>
            <Box sx={{ textAlign: 'center', py: 2 }}>
              ...
              >
                Se o username{' '}
                <strong style={{ color: C.text }}>{username}</strong> existir e
                a conta ainda não estiver ativa, você receberá um novo link de
                ativação.
              </Typography>
              <Typography
                sx={{
